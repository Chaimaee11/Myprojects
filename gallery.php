			...
			<section id="primary" class="content-full-width"> <!-- **Primary Starts Here** -->            
                <div class="fullwidth-section"> <!-- **Full-width-section Starts Here** -->
                   ...
                   <div class="dt-sc-sorting-container">
                        <a data-filter="*" href="#" title ="<?php echo $cp[0] ?>" class="dt-sc-tooltip-top active-sort type1 dt-sc-button">All</a>
                        <a data-filter=".nature" href="#" title = "<?php echo $natr[0] ?>" class="dt-sc-tooltip-top type1 dt-sc-button">Nature</a>
                        <a data-filter=".people" href="#" title = "<?php echo $people[0] ?>" class="dt-sc-tooltip-top type1 dt-sc-button">People</a>
                        <a data-filter=".street" href="#" title = "0" class="dt-sc-tooltip-top type1 dt-sc-button">Street</a>
                        <a data-filter=".still-life" href="#" title = "0" class="dt-sc-tooltip-top type1 dt-sc-button">Still life</a>
                    </div>
                    	...
                    	<div class="portfolio-grid">
                            <div class="dt-sc-portfolio-container isotope"> <!-- **dt-sc-portfolio-container Starts Here** -->
                                 <?php 
                                        ...
                                        while($row=$req->fetch()){
                                        if($row['NomCategorie']=="Nature"){
                                            
                                            $cl="portfolio nature  dt-sc-one-fourth";
                                                } 
                                                elseif($row['NomCategorie']=="People"){
                                                   $cl="portfolio people  dt-sc-one-fourth";
                                                }
                                                elseif($row['NomCategorie']=="Street"){
                                                   $cl="portfolio street landscapes  dt-sc-one-fourth";
                                                }
                                                ?>
                                <div class="<?php echo $cl ?>">
                                    <figure>
                                        <img src="./admin/picTable/<?php echo $row['PhotoTab'] ?>" alt="" title="">
                                        <figcaption>
                                            <div class="portfolio-detail">
                                                <div class="views">
                                                    <a class="fa fa-camera-retro" data-gal="prettyPhoto[gallery]" href="./admin/picTable/<?php echo $row['PhotoTab'] ?>"></a><span><?php echo $row['Stock'] ?></span>
                                                </div>
                                                <div class="portfolio-title">
                                                    <h5><a href="gallery-detail-with-lhs.php?id=<?php echo $row[0] ?>"><?php echo  $row['NomTab'] ?></a></h5>
                                                    <p><?php echo $row['TypeCategorie'] ?></p>
                                                </div>
                                            </div>
                                        </figcaption>
                                    </figure>
