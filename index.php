      ...
      <div id="header-wrapper"> <!-- **header-wrapper Starts** -->
          <header id="header" class="header1">
              <div class="container">
                  ...
                  <!-- **Logo - Start** -->
                  <div class="logo">
                      <a href="index.php" title="Art Space"> <img src="images/logo.svg" alt="logo" width="70%"/> </a>
                  </div>
                  <!-- **Logo - End** -->
                  ...
                  <nav id="main-menu">
                      ...
                      <ul class="menu type4"><!-- Menu Starts -->
                        <li class="current_page_item menu-item-simple-parent"><a href="index.php">Home</a></li>
