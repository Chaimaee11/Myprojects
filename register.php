        ...
        <div class="inner-wrapper">
            ...
            <div id="main">
                <section id="primary" class="content-full-width">
                    <div class="container">
                        <div id="large-header" class=" text-center large-header">
                        ...
                        <form action="php/save_inscip.php" method="post">                               
                            ...
                            <label for="billing_address_2" class="">Address</label>
                            <input type="text" class="input-text " name="billing_address" id="billing_address" placeholder="Apartment Name, No.. etc."  value=""  /></p>
                            ...
                            <div class="create-account">
                                ...
                                <input type="submit" class="button" name="connection" value="Connection"/>
                                <div class="clear"></div>
                            </div>
                        </form>
